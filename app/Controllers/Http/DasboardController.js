...
class DasboardController {
    ...
    async index({view,auth}){
        ...
        return view.render('dasboard.index', {cate:cate[0].total, clients:clients[0].total,produits:produits[0].total,rendez:rendez_vous[0].total,representants:representants[0].total,statut_clients:statut_clients[0].total,me:auth.user} )
    }
}
